  ...
  return (
    <section className="py-12">
      <div className="container mx-auto px-6 lg:px-12">
        ...
        {/* Route Map Image Box */}
        <div className="animate-fade-in-up stagger-2 relative mx-auto w-full overflow-hidden rounded-2xl border border-black/5 bg-white p-2 shadow-sm transition-shadow duration-300 ease hover:shadow-md">
